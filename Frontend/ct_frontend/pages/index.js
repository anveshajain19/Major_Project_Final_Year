    ...
    <>
      <div className="w-full min-h-screen text-white">
        ...
        <div className="xl:px-44 md:px-10 sm:px-28 p-10 md:pt-20 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          ...
          <div className="rounded overflow-hidden px-4">
            ...
            <div className="py-4">
              ...
              <p className="text-white text-xl mt-6">
                Realtime code sharing among all the fellow programmers who are
                present in the room. Run code, share code and download code ,
                get indulged in this wondeful environment.
              </p>
          ...
          <div className="rounded overflow-hidden px-4">
            ...
            <div className="py-4">
              ...
              <p className="text-white text-xl mt-6">
                Realtime voice call, chat to appreciate seamless communication
                among the fellow programmers. Smooth voice call to communicate ,
                discuss codes through chat.
              </p>
              <div id="explore-text" className="mt-5">
                <Link href="/createroom">
                  <a className="cursor-pointer flex">
          ...
          <div className="rounded overflow-hidden px-4">
            ...
            <div className="py-4">
              ...
              <p className="text-white text-xl mt-6">
                Get help from our optimized search engine to find coding
                articles for you. Discuss and plan the algorithmic approaches
                with others , do rough work through realtime whiteboard.
              </p>
              <div id="explore-text" className="mt-5">
                <Link href="/createroom">
                  <a className="cursor-pointer flex">
        ...
        <div className="pb-8 flex justify-center">
          <span className="text-3xl">Group 7 {new Date().getFullYear()}</span>
        </div>
      </div>
    </>
  );
